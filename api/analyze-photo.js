...
//
// app10_imakoko v6
// STEP2.2 Geminiモデルフォールバック（future-me.jsと同様のリトライ強化）
// ============================================================
...
// STEP2.2: future-me.js と同様、404/invalid model に加えて
// 503/UNAVAILABLE/overloaded/timeout のような一時的な不調でも次のモデルへ進む
async function tryGenerateContent(ai, modelList, generateConfig) {
  ...
  for (const model of modelList) {
    try {
      ...
      if (isNotFound || isRetryable) continue;
      throw err;
    }
  }
